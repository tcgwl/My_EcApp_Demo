...
import com.archer.lib.core.ui.camera.CameraImageBean;
import com.archer.lib.core.ui.camera.LatteCamera;
import com.archer.lib.core.ui.camera.RequestCodes;
import com.archer.lib.core.ui.scanner.ScannerDelegate;
        ...
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                ...
                case RequestCodes.CROP_ERROR:
                    Toast.makeText(getContext(), "剪裁出差", Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
            }

...
import com.archer.lib.ec.pay.FastPay;
import com.archer.lib.ec.pay.IAlPayResultListener;
...
public class ShopCartDelegate extends BottomItemDelegate implements ISuccess, View.OnClickListener, ICartItemListener, IAlPayResultListener {
        ...
        if (count == 0) {
            ...
            tvToBuy.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ecBottomDelegate.setCurrentDelegate(indexTab);
                }
            });
